  ...
  return (
    <div className="min-h-screen bg-ivory">
      ...
      <main className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        ...
        <div className="border-t-2 border-lightGray pt-12">
          <div className="flex items-center gap-3 mb-6">
            <div className="p-2 bg-skyBlue rounded-lg">
              <svg className="w-5 h-5 text-ivory" fill="none" stroke="currentColor" viewBox="0 0 24 24">
            ...
            <h2 className="text-2xl font-bold text-darkSlateBlue">Class Management</h2>
          </div>
            ...
            <div className="lg:col-span-1">
              <div className="bg-white rounded-2xl border-2 border-skyBlue shadow-lg p-8 sticky top-24">
                <div className="flex items-center gap-3 mb-6">
                  ...
                  <h3 className="text-xl font-bold text-darkSlateBlue">Join a Class</h3>
                </div>
                ...
                <div className="mt-6 pt-6 border-t border-lightGray">
                  <p className="text-xs text-darkSlateBlue opacity-60 text-center">
                    Contact your adviser for a class code
                  </p>
                </div>
              </div>
            </div>
            ...
            <div className="lg:col-span-2">
              <div className="bg-white rounded-2xl border border-lightGray p-8">
                <div className="flex items-center gap-3 mb-6">
                  ...
                  <h3 className="text-xl font-bold text-darkSlateBlue">Pending Invitations</h3>
                </div>
                    ...
                    <div className="flex items-start justify-between gap-4">
                      <div className="flex-1">
                        <div className="flex items-center gap-3 mb-2">
                          ...
                          <div>
                            <h4 className="text-lg font-bold text-darkSlateBlue">Neuroscience Research Lab</h4>
                            <p className="text-sm text-darkSlateBlue opacity-60">Invited by Dr. Robert Wilson</p>
                          </div>
                        </div>
                        <p className="text-sm text-darkSlateBlue opacity-70 ml-14">
                          Advanced cognitive neuroscience research methods and applications
                        </p>
                      </div>
                    ...
                    <div className="flex items-start justify-between gap-4">
                      <div className="flex-1">
                        <div className="flex items-center gap-3 mb-2">
                          ...
                          <div>
                            <h4 className="text-lg font-bold text-darkSlateBlue">Data Science Practicum</h4>
                            <p className="text-sm text-darkSlateBlue opacity-60">Invited by Prof. Lisa Anderson</p>
                          </div>
                        </div>
                        <p className="text-sm text-darkSlateBlue opacity-70 ml-14">
                          Hands-on data analysis and machine learning projects
                        </p>
                      </div>
                      <button className="bg-mutedGreen text-white font-semibold py-2 px-6 rounded-lg hover:bg-opacity-90 transform hover:scale-[1.05] transition-all duration-200 shadow-sm hover:shadow whitespace-nowrap">
                        Accept
