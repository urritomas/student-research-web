...
export default function ProjectEditPage() {
    ...
    const fetchData = async () => {
        try {
            ...
            // setContributors
            // setContributorRoles
            setProgram(projectData.program);
            setCourse(projectData.course);
            setSection(projectData.section);
            setResearchType(projectData.paper_standard);
            console.log(projectData.document_reference)
    ...
    const handleSubmit = async (e: React.FormEvent) => {
        ...
        try {
            ...
            router.push('/student/projects/${params.id}');
        } catch (error: any) {
    ...
    return (
        <DashboardLayout role="student" user={user} onLogout={handleLogout}>
            <div className="max-w-3xl mx-auto space-y-6">
                {/* Page Header */}
                <div>
                <h1 className="text-3xl font-bold text-primary-700">Edit Project Details</h1>
                <p className="text-neutral-600 mt-1">Edit your research project</p>
                </div>
